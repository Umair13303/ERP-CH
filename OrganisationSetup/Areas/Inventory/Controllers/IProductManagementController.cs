...
namespace OrganisationSetup.Areas.Inventory.Controllers
{
    ...
    public class IProductManagementController : Controller
    {
        ...
        public IProductManagementController(IInventoryRetriever irService, ICompanySetupRetriever csrService, IInventoryUpsert iuService, IApplicationConfigurationRetriever IacrService, ICommon IcService)
        {
        ...
        {
            var result = await _IrService.populateSubCategoryByParam(operationType, (int?)FilterConditions.ISubCategory_Operation_ByCategory, 2);
            return Json(result);
        }
        ...
        public async Task<IActionResult> populateCostOfSaleListByParam(string operationType)
        {
            var result = await _IrService.populateSubCategoryByParam(operationType, (int?)FilterConditions.ISubCategory_Operation_ByCategory, 2);
            return Json(result);
        }
