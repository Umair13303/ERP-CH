...
namespace OrganisationSetup.Areas.ApplicationConfiguration.Services
{
    public interface IApplicationConfigurationUpsert
    {
        ...
        Task<ServiceResult> updateInsertDataInto_ACCategory(PostedData postedData);
        Task<ServiceResult> updateInsertDataInto_ACSubCategory(PostedData postedData);
    ...
    public class ApplicationConfigurationUpsertService : IApplicationConfigurationUpsert
    {
        ...
        public async Task<ServiceResult> updateInsertDataInto_ACDepartment(PostedData postedData)
        {
            ...
            bool? isOperationPermitted = await _validationService.isACDepartmentValid(postedData.OperationType, postedData.GuID, postedData.Description);
        ...
        public async Task<ServiceResult> updateInsertDataInto_ACCategory(PostedData postedData)
        {
            var userInfo = TempUser.Fill(_httpContextAccessor);
            ...
            bool? isOperationPermitted = await _validationService.isACCategoryValid(postedData.OperationType, postedData.GuID, postedData.DepartmentId, postedData.Description);
            ...
            if (isOperationPermitted == true)
            {
                ...
                try
                {
                    var result = await _repo.UpsertInto_ACCategory(
                                                            postedData.OperationType,
                                                            postedData.GuID,
                                                            postedData.Description!.Trim(),
                                                            postedData.DepartmentId,
        ...
        public async Task<ServiceResult> updateInsertDataInto_ACSubCategory(PostedData postedData)
        {
            var userInfo = TempUser.Fill(_httpContextAccessor);
            ...
            if (isOperationPermitted == true)
            {
                ...
                try
                {
                    var result = await _repo.UpsertInto_ACSubCategory(
                                                            postedData.OperationType,
                                                            postedData.GuID,
                                                            postedData.Description!.Trim(),
                                                            postedData.DepartmentId,
